...
<html lang="en">
   <head>
      ...
      <title>The 254 News Desk. | Home Page</title>
      <!-- Bootstrap core CSS -->
         ...
         <div class="row" style="margin-top: 4%; margin-left:0; margin-right:0;">
            ...
            <div class="col-md-12">
               ...
               <div class="row" style="width:100%;">
                  <div class="owl-carousel owl-theme" id="slider" style="height: 100%;">
                     <div class="card mb-4 border-0">
                        <div>
                        <img class="card-img-top" src="admin/team/ramsey.jpg" alt="" >
                        </div>
                        <div class="card-body">
                           <p class="m-0">
                              <!--category-->
                     ...
                     <div class="card mb-4 border-0">
                        <div>
                        <img class="card-img-top" src="admin/team/makinia.jpg" alt="" >
                        </div>
                        <div class="card-body">
                           <p class="m-0">
                              <!--category-->
                           ...
                           <a href="#" class="card-title text-decoration-none text-dark">
                              <h5 class="card-title">Ensuring news delivered to you are Facts and  thoroughly researched hence bringing you Timely and Authentic News</h5>
                           </a>
                           <!-- <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="">Read More &rarr;</a> -->
                        </div>
                     </div>
                     <div class="card mb-4 border-0">
                        <div>
                        <img class="card-img-top" src="admin/team/tony.jpg" alt="" >
                        </div>
                        <div class="card-body">
                           <p class="m-0">
                              <!--category-->
                              <a class="badge bg-success text-decoration-none link-light" href="#" style="color:#fff">Tony Irungu</a>
                              
                           </p>
                           <p class="m-0"><small> BBC Radio</small></p>
                           <a href="#" class="card-title text-decoration-none text-dark">
                              <h5 class="card-title">Keeping you updated on what's going on in all the corners of Kenya and around the word just as they occur, keeping you update at all times.</h5>
                           </a>
                           <!-- <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="">Read More &rarr;</a> -->
                        </div>
                     </div>
                     <div class="card mb-4 border-0">
                        <div>
                        <img class="card-img-top" src="admin/team/Vick.jpg" alt="" >
                        </div>
                        <div class="card-body">
                           <p class="m-0">
                              <!--category-->
                              <a class="badge bg-success text-decoration-none link-light" href="#" style="color:#fff">Victor Juma</a>
                              
                           </p>
                           <p class="m-0"><small> Graphic Designer</small></p>
                           <a href="#" class="card-title text-decoration-none text-dark">
                              <h5 class="card-title">Providing you with  well presented news, through quality design and presentation techniques  </h5>
                           </a>
                           <!-- <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="">Read More &rarr;</a> -->
                        </div>
                     </div>
                  ...
                  <h4 class="widget-title mb-4">Today's <span>Highlights</span></h4>
                  </div>
                  <?php 
                  ...
                  <?php } ?>
                  <div class="col-md-12"><a href = "mailto: ramsleyworkse@gmail.com">
