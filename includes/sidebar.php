<div class="col-md-12" style="align-content:center; text-align:center;">
   ...
   <div class="card my-4 border-0" >
      <div class="card-body p-2">
        <iframe width="100%" height="350" class="youtube" src="lichuma.mp4" title="Sample Videos / Dummy Videos For Demo Use" frameborder="0" allow=" autoplay; " allowfullscreen></iframe>
      </div>
   </div>
   <div class="card my-4 border-0">
      <div class="card-body p-2">
