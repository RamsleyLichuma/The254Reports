<div class="footer-area pt-3 bg-white mb-5">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col">
                            <ul class="float-left list-unstyled ">
                                <li class="mb-2"><a href="#" class="text-dark">Zone 254</a></li>
                                <li class="mb-2"><a href="#" class="text-dark">Politics</a></li>
                                <li class="mb-2"><a href="#" class="text-dark">Jiji</a></li>
                        ...
                        <div class="col d-none d-lg-block">
                            <ul class="float-left list-unstyled ">
                                ...
                                <li class="mb-2"><a href="#" class="text-dark">Rugby</a></li>
                                <li class="mb-2"><a href="#" class="text-dark">Hockey</a></li>
                                <li class="mb-2"><a href="#" class="text-dark">Athletics</a></li>
